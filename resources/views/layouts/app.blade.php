<x-tabler::layouts.vertical-transparent>
    ...
    <x-slot name="menus">
        ...
        <x-tabler::layouts.menu title="Peneliti" :route="route('dashboard.peneliti.index')" :active="request()->routeIs('dashboard.peneliti.*')"
            icon='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-flask" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
