<x-app-layout>
    <x-slot name="title">
        <div class="col">
            <div class="btn-list">
                <a href="{{ route('dashboard.skema-penelitian.index') }}" class="btn btn-secondary">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('dashboard.skema-penelitian.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
