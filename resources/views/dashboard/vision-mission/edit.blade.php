<x-app-layout>
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{ route('dashboard.vision-mission.update', $visionMission) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        >{{ $visionMission->description }}</x-tabler::form.input.textarea>
                    </div>
