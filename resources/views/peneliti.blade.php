<section class="u-clearfix u-image u-section-6" id="carousel_f410" data-image-width="1980" data-image-height="1238">
    <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        ...
        <div class="swiper relative w-full mt-10">
            <div class="swiper-wrapper">
                @foreach ($penelitis as $peneliti)
                    <div class="swiper-slide">
                        <img src="{{ $peneliti->file }}" class="rounded-full mx-auto w-52 h-52" />

                        <p class="u-text u-text-body-alt-color u-text-3 text-center">
                            {{ $peneliti->name }}
                        </p>
